if (!customElements.get("quick-add-modal")) {
  customElements.define(
    ...
    class QuickAddModal extends ModalDialog {
      ...
      // Add Swiper initialization method
      initSwipers() {
        ...
        this.handleResize = () => {
          if (
            (window.innerWidth < 768 && this.thumbnailSwiper.params.direction !== "horizontal") ||
            (window.innerWidth >= 768 && this.thumbnailSwiper.params.direction !== "vertical")
          ) {
